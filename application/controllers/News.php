...
class News extends CI_Controller {
    ...
    public function index() {
        if(!is_logged_in()) {
            $this->template->alert(
                'Hanya admin yang bisa mengakses halaman',
                'warning'
            );
    ...
    public function category($idcategory) {
        ...
        $data['title'] = $category->title . 'Arsip Berita | Berita 86';
    ...
    public function tag($idtag) {
        ...
        $data['title'] = $tag->title . ' Tag Berita| Berita 86';
    ...
    public function search($keyword = '') {
        ...
        $data['title'] = 'Search: ' . $keyword . ' Cari | Berita 86';
